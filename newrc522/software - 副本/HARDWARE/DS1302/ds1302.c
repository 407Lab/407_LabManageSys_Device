...
//初始化时间定义
u8 time_buf[8] = {0x20,0x19,0x08,0x14,0x17,0x06,0x55,0x03}; //初始时间2010年6月1号23点59分55秒 星期二
...
void DS1302_Init(void)
{
    ...
    GPIO_SetBits(GPIOB, GPIO_Pin_13);                 //PB13拉高
    GPIO_ResetBits(GPIOB, GPIO_Pin_12 | GPIO_Pin_14); //PB12，PB14置低
}
